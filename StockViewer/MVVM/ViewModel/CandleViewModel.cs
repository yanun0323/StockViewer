...
public class CandleViewModel : ObservableObject
{
    ...
    public Candle? Candle { get =>_Candle;  set { _Candle = value; OnPropertyChanged(); } }
    public Volume? Volume { get => _Volume; set { _Volume = value; OnPropertyChanged(); }}
    public Thickness CandleMargin { get => MainChartViewModel.CandleMargin; }
    public DateTime Date { get =>_Date; set => _Date = value; }
    public Price mPrice { get; set; }
